...
public partial class @PlayerInputSet: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""edcbdb2d-bdff-41ef-b422-fb2d28df6652"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""9d071643-62e2-4cf3-b116-8d470e5043e3"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""7977376b-801d-4309-bae5-54e8dc2cf83e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Dash"",
                    ""type"": ""Button"",
                    ""id"": ""9b6ab166-f27e-45ce-a686-7ffbb4e6505c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""BasicAttack"",
                    ""type"": ""Button"",
                    ""id"": ""4be8b8da-6b64-449c-bc96-bee5144f323a"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""CounterAttack"",
                    ""type"": ""Button"",
                    ""id"": ""2d40470c-bf92-42da-ba71-ea8f81e109d1"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""44cbfd0a-69cd-4ff4-88d4-c3d354a213d5"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""2cc881ef-2956-4602-a1a8-abe2d5d26d05"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""2fd20be0-9f32-4815-a9dc-b44d2af0d4ba"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard & Mouse"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""e417b2dd-1bd8-4e8e-b9b3-52b41a3d038a"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard & Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""1df36deb-fe43-4162-8b6d-48a4e83284ac"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""674ed883-cb18-4d45-8f36-9696e14af06e"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""80834865-ee7e-4d81-8cf0-2213e26173c7"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bea565eb-e836-47a8-b9f9-ac628ea8ec67"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b056225a-5a55-401e-805b-bff3ba03fbfd"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
